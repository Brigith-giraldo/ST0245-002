public class TestTaller4 {
    ...
    public static boolean ejercicio1(){
        int a,b,c,d;
        a = taller4.max(new int[] {12,324,43,2,3,43,2,3,43});
        b = taller4.max(new int[] {3,2,343,2,43,55,67,68,86,3,4});
        c = taller4.max(new int[] {56,7,6,45,8,4,34,8,7,5,34,7,78,9});
        d = taller4.max(new int[] {1,2,3,4,5,5});
